...
import { GetRequest, awsUrl } from "../components/helpers/ApiHelper";
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-12 pt-2 px-8">
          <div className="col-span-12 lg:col-span-6 px-8 lg: order-last lg:order-first ">
            ...
            <p className=" font-semibold font-inter">
              {data.passportNo !== "" ? data.passportNo : "NA"}
            </p>
   ...
   text-[24px] 3xl:text-[36px] py-5 px-8"
        ...
        <div className="px-8">
          <p
            className=" text-[#1B1465]
             text-[24px] 3xl:text-[36px] py-5 pl-6 "
          >
            Personal Details
          </p>
          ...
          <div className="grid grid-cols-1 pt-2 sm:pt-5 md:pt-10 px-5 md:px-10">
            ...
            <div className="grid grid-cols-12 sm:col-span-12 lg:col-span-6 py-8 ">
              {data.dish !== undefined
                    ...
                    return (
                      <div className="col-span-2 px-2" key={i}>
                        ...
                        <img
                          ...
                          className="md:h-35 w-full object-cover rounded"
                        />
                      </div>
                    );
                  })
